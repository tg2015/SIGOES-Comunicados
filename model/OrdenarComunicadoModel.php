...
class OrdenarComunicadoModel {
    ...
    function load_script_css() {
        if ($this->_check_load_script_css()) {
            ...
            wp_enqueue_script('jquery-ui-sortable');//plugins_url('SIGOES-Comunicados/includes/js/ImagenRequerida.js')
            wp_enqueue_script('scporderjs', plugins_url('SIGOES-Comunicados/includes/js/OrdenarComunicado.js')/*SCPORDER_URL . '/assets/scporder.js'*/, array('jquery'), null, true);

            wp_enqueue_style('scporder', plugins_url('SIGOES-Comunicados/includes/css/OrdenarComunicado.css')/*SCPORDER_URL . '/assets/scporder.css'*/, array(), null);
        }
    }
    ...
    function get_scporder_options_objects() {
        ...
        //Setear los CPT para que se puedan ordenar.
        $objects=array('proyecto','evento','streaming','otros');
        return $objects;
    }
