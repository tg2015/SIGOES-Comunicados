<?php
/*
*Nombre del módulo: Sesion
*Objetivo: Mantener Solo una sesion en el sistema
*Dirección física: /SIGOES-Comunicados/controller/Sesion.php
*/
...
function pcl_prevent_concurrent_logins() {
	...
	if (count( wp_get_all_sessions() ) > 1)
	{
